...
$username = $email    = "";
$errors = array(); 
$first_name = $last_name= $email= $gender= $fuculty= $qualification= $skills_interest = "";
...
if (isset($_POST['reg_user'])) {
  ...
  if (count($errors) == 0) {
	...
	$query_2 = "INSERT INTO students_profile(username,first_name,last_name,email,gender,fuculty,qualification,skills_interest)
...
<body style="background-color:blue">
  ...
  <form method="post" action="StudentRegistration.php">
  	...
  	<p>
  		Already a member? <a href="StudentHomePage.php">Sign in</a>
  	</p>
  </form>
</body>
</html>
